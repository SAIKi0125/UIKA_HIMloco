...
def resolve_onnx_path():
    env_path = os.environ.get("HTDW_V2_ONNX_PATH") or os.environ.get("HTDW_ONNX_PATH")
    if env_path:
        return os.path.abspath(os.path.expanduser(env_path))

    v2_candidates = sorted(glob.glob(os.path.join(PROJECT_ROOT, "onnx", "flat_htdw_4438_v2*.onnx")))
    if v2_candidates:
    ...
    return os.path.join(PROJECT_ROOT, "onnx", "flat_htdw_4438_v2.onnx")
